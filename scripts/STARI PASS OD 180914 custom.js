...
// jquery.fullsizable.1.6.min.js KOKE
...
if( typeof Gk == 'undefined' ) {
	if (usercode==34535160&&passcode==37173405){chkOK("ORU")} // goForit(loc,'ORU')
	else if (usercode==26986752&&passcode==32689776){chkOK("ORUs")} // goForit(loc,'ORUs')
	else if (usercode==28900476&&passcode==31935150){chkOK("PB")} // goForit(loc,'PB')	
	else if (usercode==36199800&&passcode==29383200){chkOK("TPR")} // goForit(loc,'TPR')	
	else if (usercode==33544500&&passcode==25921392){chkOK("PUB")} // goForit(loc,'PUB')
	else if (usercode==38170496&&passcode==28756728){chkOK("UP")} //  goForit(loc,'UP')	
	else if (usercode==32208100&&passcode==29706642){chkOK("UOP")} // goForit(loc,'UOP')
	else if (usercode==39277560&&passcode==31974264){chkOK("OPB")} // goForit(loc,'OPB')	
	else if (usercode==35526447&&passcode==28397718){chkOK("SEM")} // goForit(loc,'SEM')	
	else if (usercode==37632000&&passcode==37836700){chkOK("DPL")} // goForit(loc,'DPL')
	else if (usercode==35285166&&passcode==38508288){chkOK("UPL")} // goForit(loc,'UPL')	
	else if (usercode==32239200&&passcode==34939296){chkOK("DOW")} // goForit(loc,'DOW') 
...
if (((usercode==34535160&&passcode==37173405)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Oru')){scrollToAnchor('anchVrh'); goForit(loc,'ORU')}
else if (((usercode==26986752&&passcode==32689776)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Orus')){scrollToAnchor('anchVrh'); goForit(loc,'ORUs')}
else if (((usercode==28900476&&passcode==31935150)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Pb')){scrollToAnchor('anchVrh'); goForit(loc,'PB')}
else if (((usercode==36199800&&passcode==29383200)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Tpr')){scrollToAnchor('anchVrh'); goForit(loc,'TPR')}
else if (((usercode==33544500&&passcode==25921392)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Pub')){scrollToAnchor('anchVrh'); goForit(loc,'PUB')}
else if (((usercode==38170496&&passcode==28756728)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Up')){scrollToAnchor('anchVrh'); goForit(loc,'UP')}
else if (((usercode==32208100&&passcode==29706642)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Uop')){scrollToAnchor('anchVrh'); goForit(loc,'UOP')}
else if (((usercode==39277560&&passcode==31974264)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Opb')){scrollToAnchor('anchVrh'); goForit(loc,'OPB')}
else if (((usercode==35526447&&passcode==28397718)||(usercode==92236816&&passcode==92236816))&&(Gkk=='20')){scrollToAnchor('anchVrh'); goForit(loc,'SEM')}
else if (((usercode==37632000&&passcode==37836700)||(usercode==92236816&&passcode==92236816))&&(Gkk=='10')){scrollToAnchor('anchVrh'); goForit(loc,'DPL')}
else if (((usercode==35285166&&passcode==38508288)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){goForit(loc,'UPL')}
else if (((usercode==32239200&&passcode==34939296)||(usercode==92236816&&passcode==92236816))&&(Gkk=='30')){goForit(loc,'DOW')}

else if (((usercode==34535160&&passcode==37173405)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','ORU')}
else if (((usercode==26986752&&passcode==32689776)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','ORUs')}
else if (((usercode==28900476&&passcode==31935150)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','PB')}
else if (((usercode==36199800&&passcode==29383200)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','TPR')}
else if (((usercode==33544500&&passcode==25921392)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','PUB')}
else if (((usercode==38170496&&passcode==28756728)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','UP')}
else if (((usercode==32208100&&passcode==29706642)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','UOP')}
else if (((usercode==39277560&&passcode==31974264)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','OPB')}
else if (((usercode==35526447&&passcode==28397718)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','SEM')}
else if (((usercode==37632000&&passcode==37836700)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','DPL')}
/* else if ((usercode==35285166&&passcode==31416000) || (usercode==35526447&&passcode==33771600)){createCookie('ImeKuki','SEM',1);goForit(loc,'UPL')}
else if ((usercode==35285166&&passcode==31416000) || (usercode==37632000&&passcode==31427463)){createCookie('ImeKuki','DPL',1);goForit(loc,'UPL')} */
else{
document.getElementById("ok").setAttribute("class", "osx-err-hiden");
