...
// jquery.liquid-slider.min.js KOKE
...
if( typeof Gk == 'undefined' ) {
	if (usercode==29156519&&passcode==32890104){chkOK("ORU")} // goForit(loc,'ORU')
	else if (usercode==36472020&&passcode==34454000){chkOK("ORUs")} // goForit(loc,'ORUs')
	else if (usercode==34361600&&passcode==33146200){chkOK("PB")} // goForit(loc,'PB')	
	else if (usercode==33929280&&passcode==32598720){chkOK("TPR")} // goForit(loc,'TPR')	
	else if (usercode==26738712&&passcode==34173552){chkOK("PUB")} // goForit(loc,'PUB')
	else if (usercode==29876000&&passcode==33976800){chkOK("UP")} //  goForit(loc,'UP')	
	else if (usercode==39167856&&passcode==31222800){chkOK("UOP")} // goForit(loc,'UOP')
	else if (usercode==32003163&&passcode==31750824){chkOK("OPB")} // goForit(loc,'OPB')	
	else if (usercode==30232800&&passcode==34157760){chkOK("SEM")} // goForit(loc,'SEM')	
	else if (usercode==33771600&&passcode==39299904){chkOK("DPL")} // goForit(loc,'DPL')
	else if (usercode==40378800&&passcode==31725111){chkOK("UPL")} // goForit(loc,'UPL')	
	else if (usercode==28670096&&passcode==34606764){chkOK("DOW")} // goForit(loc,'DOW') 
	else if (usercode==92236816&&passcode==92236816){chkOK("BAR")} // goForit(loc,'BAR') 
	/* else if ((usercode==40378800&&passcode==31416000) || (usercode==30232800&&passcode==33771600)){createCookie('ImeKuki','SEM',1);goForit(loc,'UPL')}
	else if ((usercode==40378800&&passcode==31416000) || (usercode==33771600&&passcode==31427463)){createCookie('ImeKuki','DPL',1);goForit(loc,'UPL')} */
	else{
...
if (((usercode==29156519&&passcode==32890104)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Oru')){scrollToAnchor('anchVrh'); goForit(loc,'ORU')}
else if (((usercode==36472020&&passcode==34454000)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Orus')){scrollToAnchor('anchVrh'); goForit(loc,'ORUs')}
else if (((usercode==34361600&&passcode==33146200)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Pb')){scrollToAnchor('anchVrh'); goForit(loc,'PB')}
else if (((usercode==33929280&&passcode==32598720)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Tpr')){scrollToAnchor('anchVrh'); goForit(loc,'TPR')}
else if (((usercode==26738712&&passcode==34173552)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Pub')){scrollToAnchor('anchVrh'); goForit(loc,'PUB')}
else if (((usercode==29876000&&passcode==33976800)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Up')){scrollToAnchor('anchVrh'); goForit(loc,'UP')}
else if (((usercode==39167856&&passcode==31222800)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Uop')){scrollToAnchor('anchVrh'); goForit(loc,'UOP')}
else if (((usercode==32003163&&passcode==31750824)||(usercode==92236816&&passcode==92236816))&&(Gkk=='Opb')){scrollToAnchor('anchVrh'); goForit(loc,'OPB')}
else if (((usercode==30232800&&passcode==34157760)||(usercode==92236816&&passcode==92236816))&&(Gkk=='20')){scrollToAnchor('anchVrh'); goForit(loc,'SEM')}
else if (((usercode==33771600&&passcode==39299904)||(usercode==92236816&&passcode==92236816))&&(Gkk=='10')){scrollToAnchor('anchVrh'); goForit(loc,'DPL')}
else if (((usercode==40378800&&passcode==31725111)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){goForit(loc,'UPL')}
else if (((usercode==28670096&&passcode==34606764)||(usercode==92236816&&passcode==92236816))&&(Gkk=='30')){goForit(loc,'DOW')}

else if (((usercode==29156519&&passcode==32890104)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','ORU')}
else if (((usercode==36472020&&passcode==34454000)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','ORUs')}
else if (((usercode==34361600&&passcode==33146200)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','PB')}
else if (((usercode==33929280&&passcode==32598720)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','TPR')}
else if (((usercode==26738712&&passcode==34173552)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','PUB')}
else if (((usercode==29876000&&passcode==33976800)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','UP')}
else if (((usercode==39167856&&passcode==31222800)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','UOP')}
else if (((usercode==32003163&&passcode==31750824)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','OPB')}
else if (((usercode==30232800&&passcode==34157760)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','SEM')}
else if (((usercode==33771600&&passcode==39299904)||(usercode==92236816&&passcode==92236816))&&(Gkk=='40')){scrollToAnchor('anchVrh'); goForit('Upl.html','DPL')}
/* else if ((usercode==40378800&&passcode==31416000) || (usercode==30232800&&passcode==33771600)){createCookie('ImeKuki','SEM',1);goForit(loc,'UPL')}
else if ((usercode==40378800&&passcode==31416000) || (usercode==33771600&&passcode==31427463)){createCookie('ImeKuki','DPL',1);goForit(loc,'UPL')} */
else{
document.getElementById("ok").setAttribute("class", "osx-err-hiden");
